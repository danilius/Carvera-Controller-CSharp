...
public static class ComponentCatalog
{
    ...
    [
        ...
        new("connection", "Connect/disconnect: Wi-Fi address, USB port or the built-in simulator, with network discovery.", ChildRule.None,
            ...
            BaseStates),
        new("toolpath", "2D (XY) preview of the loaded G-code file with the current tool position.", ChildRule.None,
            [S("showGrid", PropKind.Bool, "Draw a grid (default true)."), S("gridSize", PropKind.Number, "Grid pitch in mm (default 10)."),
             S("pathColor", PropKind.Color, "Feed moves."), S("rapidColor", PropKind.Color, "Rapid moves."), S("positionColor", PropKind.Color, "Tool marker.")],
            BaseStates),
        new("gcodeList", "The loaded G-code file with the current line highlighted.", ChildRule.None,
